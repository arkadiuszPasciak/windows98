...
test.describe("Controller", () => {
	test("should interact with buttons to increase or decrease hours, minutes and seconds", async ({ mount }) => {
		...
		await expect(component.getByTestId("ds-input-input-stepper-hours")).toHaveValue("1")
		await expect(component.getByTestId("ds-input-input-stepper-minutes")).toHaveValue("1")
		await expect(component.getByTestId("ds-input-input-stepper-seconds")).toHaveValue("1")

		await hoursDownButton.click()
		await minutesDownButton.click()
		await secondsDownButton.click()

		await expect(component.getByTestId("ds-input-input-stepper-hours")).toHaveValue("0")
		await expect(component.getByTestId("ds-input-input-stepper-minutes")).toHaveValue("0")
		await expect(component.getByTestId("ds-input-input-stepper-seconds")).toHaveValue("0")
	})
})
